                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <form action="{{asset('administrator/edit-Motel/').'/'.$id_request}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label>Tên Danh Mục Sản phẩm</label>

                                            <input type="text" class="form-control" data-toggle="input-mask" name="" value="{{$motel_edit->motel_name}}" data-mask-format="00/00/0000">
                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Duyệt bài :  </label>
                                           <select name="trending" class="form-control">
                                            @if($motel_edit->trending == 1)
                                         ...
                                         <div class="form-group" >
                                           ...
                                           <select name="action" class="form-control">
                                            @if($motel_edit->action == 1)
                                                 <option value="1" selected>Đã Duyệt</option>
                                                  <option value="0"  >Không</option>
                                            @elseif($motel_edit->action == 0)
